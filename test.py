...
from SpeechTools import speech as speechObject

speechObject.speak(textCommand="Hey, User")
speechObject.speak(textCommand="This is the testing module version 2.0")